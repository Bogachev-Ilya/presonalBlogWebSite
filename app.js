...
const homeStartingContent = "To add new post simple click on Compose link. To create new posts type in web address brouser: posts/newPostName";
...
app.get("/posts/:posttitle", function (req, res) {
    ...
    Post.findOne({ title: postToLowerCase }, function (err, result) {
        if (err) {
            console.log(err);
        } else {
            if (result) {
